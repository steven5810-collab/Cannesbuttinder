...
export default function App() {
  ...
  function openWatch() {
    if (noFilm) {
      ...
      else window.open(cur.u, '_blank', 'noopener');
      return;
    }
      ...
      <div style={S.stackWrap}>
        ...
        <div ref={cardRef} style={S.card}
          ...
          {watching ? (
            <div style={S.watchLayer}>
              ...
              <div style={S.watchBar}>
                ...
                <a href={cur.u} target="_blank" rel="noopener noreferrer" style={S.openBtn}>OPEN &#8599;</a>
          ...
          <div style={S.mediaArea}>
            ...
            {noFilm ? (
              <a ref={linkRef} href={cur.u} target="_blank" rel="noopener noreferrer" style={Object.assign({}, S.noFilm, { background: tierStyle.bg, color: tierStyle.fg })}>
                <span style={S.noFilmKicker}>NO FILM ON FILE</span>
...
const S = {
  ...
  openBtn: { fontFamily: HEAD, fontSize: 10, letterSpacing: '0.1em', color: '#D4FF3D', border: '1px solid #4A5527', padding: '9px 11px', flexShrink: 0, textDecoration: 'none' },
